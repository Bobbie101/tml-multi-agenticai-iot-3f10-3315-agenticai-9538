Scaling [tml-multi-agenticai-iot-3f10-3315-agenticai-9538] With Kubernetes
===========================
...
Based on your TML solution [tml-multi-agenticai-iot-3f10-3315-agenticai-9538] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`tml-multi-agenticai-iot-3f10-3315-agenticai-9538.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-tml-multi-agenticai-iot-3f10-3315-agenticai-9538.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresstml-multi-agenticai-iot-3f10-3315-agenticai-9538.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f tml-multi-agenticai-iot-3f10-3315-agenticai-9538.yml -f ollama.yml

tml-multi-agenticai-iot-3f10-3315-agenticai-9538.yml
------------------------

.. important::
   Copy and Paste this YAML file: tml-multi-agenticai-iot-3f10-3315-agenticai-9538.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/Bobbie101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/tml-multi-agenticai-iot-3f10-3315/ymls/tml-multi-agenticai-iot-3f10-3315-agenticai-9538
...
.. code-block:: YAML
   ...
   ################# tml-multi-agenticai-iot-3f10-3315-agenticai-9538.yml
     ...
     kind: Deployment
     metadata:
       name: tml-multi-agenticai-iot-3f10-3315-agenticai-9538
     spec:
       selector:
         matchLabels:
           app: tml-multi-agenticai-iot-3f10-3315-agenticai-9538
       ...
       template:
         ...
         spec:
           containers:
           - name: tml-multi-agenticai-iot-3f10-3315-agenticai-9538
             image: Bobbie101/tml-multi-agenticai-iot-3f10-3315-agenticai-9538-arm64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: SOLUTIONNAME
               value: 'tml-multi-agenticai-iot-3f10-3315-agenticai-9538'
             - name: SOLUTIONDAG
   ...
   ---
     ...
     kind: Service
     metadata:
       name: tml-multi-agenticai-iot-3f10-3315-agenticai-9538-visualization-service
       labels:
         app: tml-multi-agenticai-iot-3f10-3315-agenticai-9538-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/tml-multi-agenticai-iot-3f10-3315-agenticai-9538 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-tml-multi-agenticai-iot-3f10-3315-agenticai-9538.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-tml-multi-agenticai-iot-3f10-3315-agenticai-9538.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-tml-multi-agenticai-iot-3f10-3315-agenticai-9538.yml
