[tml-multi-agenticai-iot-3f10-3315-agenticai-9538] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tml-multi-agenticai-iot-3f10-3315-agenticai-9538] container is NOT running**.

.. tip::
   You must have your [tml-multi-agenticai-iot-3f10-3315-agenticai-9538] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   Refer to the original solution container and documenation here: https://tml-multi-agenticai-iot-3f10-3315-agenticai-9538.readthedocs.io/en/latest/operating.html
...
.. code-block::
   ...
   docker run -d --net=host -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=tml-multi-agenticai-iot-3f10-3315-agenticai-9538 \
          ...
          Bobbie101/tml-multi-agenticai-iot-3f10-3315-agenticai-9538-arm64
...
[tml-multi-agenticai-iot-3f10-3315-agenticai-9538] Github Repo
---------------
...
.. important::
   https://tml-multi-agenticai-iot-3f10-3315-agenticai-9538.readthedocs.io
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=37273, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=34677, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=39487, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=35429, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=41461, HPDEHOST=172.17.0.2, HPDEPORT=39343, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=35357

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6621-tml-multi-agenticai-iot-3f10-3315-agenticai-9538,solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10-3315, python-preprocess-9537-tml-multi-agenticai-iot-3f10-3315-agenticai-9538,solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10-3315, python-agenticai-6825-tml-multi-agenticai-iot-3f10-3315-agenticai-9538,solution_preprocessing_agenticai_dag-tml-multi-agenticai-iot-3f10-3315, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
